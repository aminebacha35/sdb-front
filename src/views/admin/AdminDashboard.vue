...
const navItems = [
  ...
  { name: 'garage', label: 'Parc garage', icon: 'car' }
]
...
const getIcon = (icon: string) => {
  const icons: { [key: string]: string } = {
    ...
    car: '<svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M3 13l2-3h14l2 3v6a1 1 0 01-1 1h-1a2 2 0 11-4 0H8a2 2 0 11-4 0H3a1 1 0 01-1-1v-6z"></path><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M5 6h14v2H5V6z"></path></svg>'
