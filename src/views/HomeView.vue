    ...
    <section class="relative bg-primary-700 text-white py-20">
      <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="text-center">
          ...
          <button @click="navigateToAppointment" class="btn bg-accent-600 hover:bg-accent-700 text-white px-8 py-3 text-lg">
            Prendre rendez-vous
          </button>
        </div>
      </div>
      <!-- Background decoration -->
      <div class="absolute bottom-0 left-0 right-0 h-20 bg-white" style="clip-path: polygon(0 100%, 100% 100%, 0 0);"></div>
    </section>
      ...
      <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
          ...
          <div class="card p-6 hover:shadow-lg transition-shadow">
            ...
            <h3 class="text-xl font-bold mb-2">Diagnostic & Réparation</h3>
            <p class="text-gray-600 mb-4">
          ...
          <div class="card p-6 hover:shadow-lg transition-shadow">
            ...
            <h3 class="text-xl font-bold mb-2">Pneumatiques</h3>
            <p class="text-gray-600 mb-4">
    ...
    <section class="bg-gray-100 py-16">
      <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          <!-- Feature 1 -->
          <div class="text-center">
            <div class="h-12 w-12 rounded-full bg-primary-100 text-primary-700 flex items-center justify-center mx-auto mb-4">
              <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-6 h-6">
                <path stroke-linecap="round" stroke-linejoin="round" d="M9 12.75L11.25 15 15 9.75M21 12a9 9 0 11-18 0 9 9 0 0118 0z" />
              </svg>
            </div>
            <h3 class="text-lg font-bold mb-2">Expertise Certifiée</h3>
          ...
          <div class="text-center">
            ...
            <h3 class="text-lg font-bold mb-2">Service Rapide</h3>
            <p class="text-gray-600">
              Diagnostic rapide et réparations efficaces pour minimiser votre temps d'attente.
            </p>
          </div>
          ...
          <div class="text-center">
            ...
            <h3 class="text-lg font-bold mb-2">Garantie de Service</h3>
            <p class="text-gray-600">
              Tous nos travaux sont garantis pour votre tranquillité d'esprit.
            </p>
          </div>
          ...
          <div class="text-center">
            ...
            <h3 class="text-lg font-bold mb-2">Prix Transparents</h3>
            <p class="text-gray-600">
              Devis clairs et prix compétitifs sans frais cachés.
            </p>
          </div>
        </div>
      </div>
      ...
      <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="bg-primary-700 rounded-lg shadow-xl overflow-hidden">
          <div class="px-6 py-12 md:py-20 md:px-12 text-center text-white">
            ...
            <button @click="navigateToAppointment" class="btn bg-white text-primary-700 hover:bg-gray-100 px-8 py-3 text-lg">
              Réserver maintenant
            </button>
          </div>
        </div>
